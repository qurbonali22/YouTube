...
import com.example.YouTube.exception.ChannelNotExistsException;
import com.example.YouTube.exception.PlaylistNoAccessException;
import com.example.YouTube.exception.PlaylistNotFoundException;
...
//    }
    ...
    private ProfileInfoDTO toProfileInfo(ProfileEntity entity) {
        ...
        dto.setPhoto(getPreviewAttach(entity.getAttach()));
    ...
    private ChannelShortDTO toChannelInfo(ChannelEntity entity) {
        ...
        dto.setId(entity.getId());
        dto.setName(entity.getName());
        dto.setPhotoUrl(attachDownloadUrl + entity.getPhotoId() + "." + entity.getPhoto().getExtension());
